...
<!-- ini navbar Bosq-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand text-white" href="index.php">Projek_Laundry</a>
    ...
    <h6 class="m-0 font-weight-bold text-primary">Detail:</h6>
      ...
      <div class="card-body">
          ...
          <table class="table">
            ...
            <tr>
              <td>Jumlah</td>
              <td><?php echo "Rp.250".number_format($d['jumlah']).",00"; ?></td>
            </tr>
...
<div class="row">
<div class="col-md-4">
<a href="pemesanan.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
</div>
<div class="col-md-8">
