...
<!-- ini navbar Bosq-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand text-white" href="Admin_projek/transaksi.php">Projek_Laundry</a>
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" href="admin_projek/customers.php">Customers</a>
</li>
...
<div class="collapse navbar-collapse" id="navbarNavDropdown">
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" href="Admin_projek/contact.php">Kontak</a>
</li>
...
<h6 class="m-0 font-weight-bold text-primary">Tambah Costumer:</h6>
  ...
  <div class="card-body">
    ...
    <?php
     ...
     $panggil = mysqli_query($conn, "SELECT * FROM data_bulan");
     $sip = mysqli_fetch_assoc($panggil);
