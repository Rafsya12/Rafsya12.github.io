...
<!-- ini navbar Bosq-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand text-white" href="#">data transaksi</a>
...
<li class="nav-item dropdown">
         ...
         data transaksi
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="pemesanan.php">input transaksi</a></li>
...
<h6 class="m-0 font-weight-bold text-primary">input  data transaksi:</h6>
  ...
  <div class="card-body">
    ...
    <?php
     ...
     $panggil = mysqli_query($conn, "SELECT * FROM data_pemesanan");
     ...
     $insert = mysqli_query($conn, "INSERT INTO data_pemesanan VALUES (
      NULL,
      '$nama',
      '$alamat',
      '$nomor',
