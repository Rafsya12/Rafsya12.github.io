    ...
    <!-- ini navbar Bosq-->
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <div class="container-fluid">
            <a class="navbar-brand text-white" href="beranda.php"> Data Minggu Ini </a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon">Data Pelanggan</span>
            </button>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li><a class="dropdown-item" href="beranda.php">Tambah data</a></li>
                  </ul>
                </li>
              </ul>
            </div>
...
<h6 class="m-0 font-weight-bold text-primary">Data Masuk Minggu Ini:</h6>
  ...
  <div class="card-body">
    ...
    $jumlahd=mysqli_fetch_array($Jumlah_y);
     ...
     <b>Laporan Keuangan: <?php echo " Rp800.". number_format($jumlahd['tos']).",00"; ?></b>
